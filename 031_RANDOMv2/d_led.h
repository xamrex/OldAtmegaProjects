...
#define 	CA1 	(1<<PD7)		// CA1 oznacza bit nr.0 portu D
#define 	CA2 	(1<<PD6)		// CA2 oznacza bit nr.1 portu D
#define 	CA3 	(1<<PD5)		// CA3 oznacza bit nr.2 portu D
#define 	CA4 	(1<<PD4)		// CA4 oznacza bit nr.3 portu D
...
extern volatile int16_t cy1;
extern volatile int16_t cy2;
extern volatile int16_t cy3;
extern volatile int16_t cy4;
